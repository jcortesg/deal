  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved raffle as @raffle" do
        ...
        post :create, {:raffle => { "fb_id" => "invalid value" }}, valid_session
        assigns(:raffle).should be_a_new(Raffle)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested raffle" do
        ...
        Raffle.any_instance.should_receive(:update_attributes).with({ "fb_id" => "MyString" })
        put :update, {:id => raffle.to_param, :raffle => { "fb_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the raffle as @raffle" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Raffle.any_instance.stub(:save).and_return(false)
        put :update, {:id => raffle.to_param, :raffle => { "fb_id" => "invalid value" }}, valid_session
        assigns(:raffle).should eq(raffle)
      end
